	...
	pl: {
		page: {
			seo: {
				...
				meta: {
					description:
						"Poznaj swój zespół specjalistów. Dowiedz się kim jesteśmy i co możemy Tobie zaoferować. Sprawdź nas!",
					title: "Poznaj zespół specjalistów - RadWEB",
				},
				og: {
					description:
						"Dowiedz się kim jesteśmy oraz w czym jesteśmy wyspecjalizowani. Sprawdź nas już teraz!",
					title: "Poznaj zespół specjalistów RadWEB",
				},
			},
			content: {
				hero: {
					content:
						"Animi doloremque qui neque labore. In in similique. Deserunt minima accusamus iste sit voluptate ut dolor. Nihil quia natus nesciunt nam tempora aut ut pariatur sunt. Dicta vel consequatur recusandae qui qui atque. Iure esse numquam laboriosam quia dignissimos eligendi quasi dolorem. Delectus non hic est nam suscipit omnis. Facilis placeat eligendi voluptatem mollitia beatae adipisci ratione. Adipisci ut amet sunt et. Nisi doloribus inventore voluptatem iure nostrum et quibusdam laborum. Numquam et aperiam tempore ut aliquid fugit. Similique ratione facilis.",
					title: "O nas",
				},
				peoplesCards: [
					{
				...
				mission: {
					content:
						"Ipsam nihil dolorem. Totam praesentium quam qui temporibus quia ex. Tempora hic fugit voluptas molestiae. Expedita temporibus quis distinctio numquam et eaque officia. Magnam consectetur enim officia totam itaque optio.Molestias quidem vel ratione modi veritatis consequuntur. Quidem a magnam nobis eos. Eius debitis et perferendis vel accusantium.Adipisci nesciunt quis et eum voluptatibus et velit. Rem quod ratione ipsa in qui omnis ipsa. Eligendi optio eum ratione qui deserunt necessitatibus explicabo.",
					title: "Nasza misja",
					cards: [
						{
							icon: <FaHandsHelping />,
		...
		radoslaw_adamczyk: {
			seo: {
				...
				meta: {
					description:
						"Nazywam się Radosław Adamczyk i od 2016 roku zajmuję się stronami interentowymi, czyli ich tworzeniem, utrzymywaniem oraz pozycjonowaniem. Zapraszam!",
					title: "Radosław Adamczyk, programista, pozycjoner, Poznań - RadWEB",
				},
				og: {
					description:
						"Dowiedz się czym się zajmuję, oraz jak mogę Tobie pomóc. Zapraszam!",
					title: "Radosław Adamczyk - Programista, specjalista SEO/SEM",
				},
			},
			content: {
				hero: {
					...
					image:
						"https://scontent-frt3-2.xx.fbcdn.net/v/t39.30808-6/320637585_556006019305036_2965245612562101645_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeFSXTzRiKwZ8ACQHDhAlqXgHysRVyhbDVIfKxFXKFsNUo7WIAnRt-EOMgiDCKsAf-35UrNb5s-3s0HnHgF2JquG&_nc_ohc=ObDCLc16kuUAX-AYIzP&_nc_ht=scontent-frt3-2.xx&oh=00_AfAbf6ip_Jq_3MIs9BNvx4E9F4whH8fL50pNEDfeklik4A&oe=63B54A13",
					jobs: "Front-end, Web developer, Specjalista ds. SEO/SEM",
					socials: [
