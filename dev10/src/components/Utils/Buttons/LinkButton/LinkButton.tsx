    ...
    return (
        <div className={css.primary__wrapper} >
            <Link className={css.primary__box} href={props.uri}>
                <i className={css.primary__icon}><FaChevronLeft /></i>
                <span  className={css.primary__label} >{props.label}</span>
                <i className={css.primary__icon}><FaChevronRight /></i>
            </Link>
        </div>
    )
}
...
function Secondary(props:tSecondary){
    return(
        <div className={css.secondary__wrapper} >
            <Link className={css.secondary__box} data-filled={props.filled} data-rounded={props.rounded} href={props.uri}>
                <span  className={css.secondary__label} >{props.label}</span>
                {
                    props.iconify &&
                    <i className={css.secondary__icon}><MdArrowRightAlt /></i>
                }
            </Link>
        </div>
    )
...
function Tertiary(props:tTertiary){
    return(
        <Link className={css.tertiary__box} href={props.uri}>
            ...
            <i className={css.tertiary__icon}><RiArrowRightUpLine /></i>
        </Link>
    )
}
