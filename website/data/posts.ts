	...
	articles: [
		{
			...
			image:
				"https://images.unsplash.com/photo-1555255707-c07966088b7b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80",
		...
		},
		{
			...
			image:
				"https://images.unsplash.com/photo-1624571395775-253d9666612b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
		...
		},
		{
			...
			image:
				"https://cdn.pixabay.com/photo/2017/09/05/10/19/business-2717063_960_720.jpg",
	...
	projects: [
		{
			...
			content:
				"RadWEB FilmBase to aplikacja, która umożliwi Tobie szybkie oraz intuicyjne wyszukiwanie dowolonego filmu, serialu bądź obsadę aktorską",
			image:
		...
		},
		{
			...
			content:
				"Borówki są jednym z najlepszych owoców w deserach. Równie dobre są przetwory jak chociażby powidła borówkowe. Natomiast najlepszym doświadczeniem jest stworzenie strony dla Borówkowego Gaju",
			image:
				"https://images.unsplash.com/photo-1554795808-3231c32711cf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=736&q=80",
